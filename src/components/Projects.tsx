      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {projects.map((project) => (
          <button
            ...
            className="rounded-lg border border-border bg-surface p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:border-accent/60 hover:shadow-[0_12px_30px_-14px_rgba(0,0,0,0.5)]"
          >
